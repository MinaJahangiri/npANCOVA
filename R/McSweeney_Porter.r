...
#'
#' @references
#' McSweeney, M., & Porter, A. (1971). Small sample properties of nonparametric index of response and rank analysis of covariance. \emph{Omega}, 16.
#'
...
#' @export
McSweeney_Porter <- function(formula, data) {
