...
#'
#' Performs the Puri and Sen method using an unbiased
...
#'
#' @references
#' Puri, M. L., & Sen, P. K. (1969). Analysis of covariance based on general rank scores. \emph{The Annals of Mathematical Statistics}, 40(2), 610-618.
#'
...
#' @export
Puri_Sen_UVCM <- function(formula, data) {
