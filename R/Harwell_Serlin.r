...
#'
#' @references
#' Harwell, M. R., & Serlin, R. C. (1988). An empirical study of a proposed test of nonparametric analysis of covariance. \emph{Psychological Bulletin}, 104(2), 268.
#'
#' @examples
...
#' @export
Harwell_Serlin <- function(formula, data) {
