...
#'
#' Implements the Burnett and Barr rank-based method for ANCOVA. This method 
#' compares groups while adjusting for only one covariate.
#'
...
#' @export
Burnett_Barr <- function(formula, data) {
